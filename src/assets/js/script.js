...
// //toggle menu in Mobile Screen Sizes
// $(document).on("click", "a.dropdown-item", (e) => {
//     // $("ul.sub-menu").removeClass("drop-show");
//     let x2 = $(e.target);
//     let test = x2.parent("li");
//     let targetElement = test.children("ul.sub-menu");
    
//     targetElement.toggleClass("drop-show");
